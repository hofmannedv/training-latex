...
% -----------------------------------------------------------
% demonstrates how to write a book class LaTeX document with 
% table of contents
%
...
% enable references you can click on to jump to the referenced 
% document part
% - colorlinks: coloured links instead of framed boxes
